...
public class OrderSerdeConsumer<K extends Serializable, V extends Serializable> {
    ...
    private static final Logger logger = LoggerFactory.getLogger(OrderSerdeConsumer.class);
    ...
    public static void main(String[] args) {
        ...
        OrderSerdeConsumer<String, OrderRecord> baseConsumer = new OrderSerdeConsumer<>(props, List.of(topicName));
